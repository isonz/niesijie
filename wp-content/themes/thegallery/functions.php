<?php 
	...
	*/
	...
	define('GAL_TMB_DEST', TEMPLATEPATH . '/gallery/.quarantine'); // gallery thumbnail destination
	define('GAL_REAL_DEST', GOODLAYERS_PATH . '/gallery'); // gallery thumbnail destination
	define('GAL_IMG_DEST', GOODLAYERS_PATH . '/gallery/.quarantine'); // gallery thumbnail destination
