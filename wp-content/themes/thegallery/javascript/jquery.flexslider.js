...
jQuery(document).ready(function() {
	...
	jQuery('.flexslider').not('.flexslider-gallery').flexslider( FLEX );
	
	jQuery('.flexslider-gallery').each(function(){
		FLEX.slideshowSpeed = (Math.random() * 3000) + 3000;
		FLEX.animationDuration = 1500;
		jQuery(this).flexslider( FLEX );
	});
});