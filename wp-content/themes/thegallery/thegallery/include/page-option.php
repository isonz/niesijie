<?php 
	...
	*/
	...
	$page_meta_boxes = array(
		"Open Normal Section" => array('type'=>'open','id'=>'gdl-page-normal-section', 'hr'=>'none'),
		...
		"Close Normal Section" => array('type'=>'close', 'hr'=>'none'),
		
		"Open Gallery Section" => array('type'=>'open','id'=>'gdl-page-gallery-section', 'hr'=>'none'),
		
		"Gallery Root Folder" => array(
			'title'=> __('GALLERY ROOT FOLDER', 'gdl_back_office'),
			'name'=> 'page-option-gallery-root-folder',
			'type'=> 'combobox',
			'options'=> array_merge(array('All'), get_directory_list(GAL_DEST, 'dir'))
		),		
		
		"Close Gallery Section" => array('type'=>'close', 'hr'=>'none'),

		"Bg Slider Type" => array(
			'title'=> __('BG SLIDER', 'gdl_back_office'),
	...
	function add_page_option_element(){
		...
		foreach( $page_meta_boxes as $page_meta_box ){
			...
			}else if( $page_meta_box['type'] == 'page-option-item' ){
	...
	function save_page_option_meta($post_id){
		...
		foreach ($edit_meta_boxes as $edit_meta_box){
			...
			}else if(  $edit_meta_box['type'] == 'open' ||  $edit_meta_box['type'] == 'close' ||  $edit_meta_box['type'] == 'text' ){
