<?php
	...
	*/
	...
	$goodlayers_menu = array(			
		...
		__('Overall Elements', 'gdl_back_office') => array(
			...
			__('Gallery Page', 'gdl_back_office')=>'gdl_panel_gallery_page'),
		...
		__('Elements Color', 'gdl_back_office') => array(
			...
			__('Gallery', 'gdl_back_office')=>'gdl_panel_gallery',
	...
	$goodlayers_element = array(
		...
		'gdl_panel_page_style' => array(
			...
			__('SEARCH/ARCHIVE BACKGROUND IMAGE', 'gdl_back_office')=>array(
				'type'=>'combobox',
				'options'=>get_title_list( 'page' ),
				'name'=>THEME_SHORT_NAME.'_archive_background_image',
				'default'=>'main'),
			__('POST/PORT BACKGROUND IMAGE', 'gdl_back_office')=>array(
				'type'=>'combobox',
				'options'=>get_title_list( 'page' ),
				'name'=>THEME_SHORT_NAME.'_post_background_image',
				'default'=>'main'),
		...
		'gdl_panel_font' => array(
			...
			__('BG SLIDER TITLE FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_bg_slider_title_font', 'exclude'=>'Google Font',
				'description'=>'Choose the font to use with the backgroudn slider. (This field does not supported the cufon or custom uploaded font. )'),
		),
		...
		'gdl_panel_logo' => array( 
			...
			__('LOGO LEFT MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_left_margin','default'=>'15'),
			__('LOGO BOTTOM MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_bottom_margin','default'=>'15',
				'description'=>'Input number to set the bottom space of the logo. The minimum value is 1.'),
			__('NAVIGATION TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_navigation_top_margin','default'=>'15'),
			__('NAVIGATION RIGHT MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_navigation_right_margin','default'=>'15'),
		),
		...
		'gdl_panel_gallery_page' => array(
			__('FIRST BOTTOM SLIDE WIDTH', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_first_bottom_slide_width','default'=>'210'),
			__('FIRST BOTTOM SLIDE HEIGHT', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_first_bottom_slide_height','default'=>'130'),
			__('SECOND BOTTOM SLIDE WIDTH', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_second_bottom_slide_width','default'=>'155px',
				'description'=>'The second bottom slide height will be variable due to the proportion of first bottom slide width and height.'),
			__('GALLERY PAGE IMAGE WIDTH', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_gallery_page_image_width','default'=>'220'),
			__('GALLERY PAGE IMAGE HEIGHT', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_gallery_page_image_height','default'=>'165'),
		),
		...
		'gdl_panel_navigation' => array(
			__('TOP NAVIGATION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_navigation_background','default'=>'#ffffff'),
			__('TOP NAVIGATION BOTTOM BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_navigation_bottom_bar','default'=>'#dadada',
			...
			__('SUB NAVIGATION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_background','default'=>'#f3f3f3'),
			__('SUB NAVIGATION BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_border','default'=>'#dadada'),
			__('SUB NAVIGATION TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text','default'=>'#707070'),
			...
			__('SUB NAVIGATION TEXT CURRENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text_current','default'=>'#707070'),
		),		
		...
		'gdl_panel_body' => array(	
			...
			__('PAGE HEADER LEFT LINE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_left_line','default'=>'#ffbc2d'),	
			__('PAGE HEADER BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_background_color','default'=>'#333333'),	
			__('PAGE HEADER TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_text_color','default'=>'#ffffff'),	
			__('PAGE HEADER CAPTION COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_caption_color','default'=>'#acacac'),	
			__('PAGE HEADER BOTTOM BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_bottom_border','default'=>'#000000'),	
			__('TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_title_color','default'=>'#ffbc2d',
			...
			__('SIDEBAR TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_title_color','default'=>'#ffbc2d'),
			__('SIDEBAR LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_link_color','default'=>'#ffffff'),
			__('SIDEBAR LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_link_hover_color','default'=>'#ffbc2d'),
			__('CONTENT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_content_color','default'=>'#f7f7f7'),
			__('BODY BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_body_background','default'=>'#222222',
			...
			__('CONTAINER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_container_background','default'=>'#000000',
				'description'=>'Container background is a background over the body background. You can chage it to any color you want.'),
			__('CONTAINER OPACITY', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_container_opacity','default'=>'0.7'),
			__('LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_color','default'=>'#ffbc2d',
				'description'=>'This color effects all of the link color in this theme.'),
			__('LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_hover_color','default'=>'#ffbc2d',
			...
			__('TABLE BORDER (TABLE TAG)', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_table_border','default'=>'#101010'),
			__('TABLE TITLE TEXT COLOR (TH TAG)', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_table_text_title','default'=>'#858585'),
			__('TABLE TITLE BACKGROUND (TH TAG)', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_table_title_background','default'=>'#2b2b2b'),
			__('BLOCK QUOTE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_block_quote_color','default'=>'#777777'),
			__('BLOCK QUOTE BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_block_quote_border','default'=>'#dddddd'),
			),
		
		'gdl_panel_footer' => array(	
			__('FOOTER ICON TYPE', 'gdl_back_office')=>array('type'=>'combobox','name'=>THEME_SHORT_NAME.'_footer_icon_type','options'=>array('0'=>'light','1'=>'dark'),
				'description' =>'There are two icon types in this theme, dark and light, you can choose it to display on footer as you want.'),
			__('FOOTER OPACITY', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_footer_opacity','default'=>'0.45'),
			__('FOOTER LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_link_color','default'=>'#ffbc2d',
				'description'=>'This color changes all of the link color inside footer in normal state.'),
			__('FOOTER LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_link_hover_color','default'=>'#ffd885',
				'description'=>'This is the link color of footer in "hover" state.'),
			...
			__('FOOTER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_background','default'=>'#000000'),
			__('FOOTER DIVIDER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_divider_color', 'default'=>'#303030'),
			...
			__('FOOTER INPUT BOX BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_input_background', 'default'=>'#1f1f1f'),
			__('FOOTER INPUT BOX BORDER', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_input_border', 'default'=>'#1f1f1f'),
		...
		'gdl_panel_gallery' => array(
			__('FRIST BOTTOM SLIDE BG')=> array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_main_bottom_slide_bg', 'default'=>'#ffffff'),
			__('FIRST BOTTOM SLIDE TITLE')=> array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_main_bottom_slide_text', 'default'=>'#151515'),
			__('FIRST BOTTOM SLIDE OVERLAY')=> array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_main_bottom_slide_overlay', 'default'=>'#000000'),
			__('FIRST BOTTOM SLIDE OVERLAY OPACITY')=> array('type'=>'inputtext', 'name'=>THEME_SHORT_NAME.'_main_bottom_slide_overlay_opacity', 'default'=>'0.55'),	
			__('GALLERY HEADER TITLE')=> array('type'=>'inputtext', 'name'=>THEME_SHORT_NAME.'_gallery_header_title', 'default'=>'#ffffff'),	
			__('GALLERY HEADER CAPTION')=> array('type'=>'inputtext', 'name'=>THEME_SHORT_NAME.'_gallery_header_caption', 'default'=>'#acacac'),	
			__('GALLERY HEADER BACKGROUND OPACITY')=> array('type'=>'inputtext', 'name'=>THEME_SHORT_NAME.'_gallery_header_background_opacity', 'default'=>'0.85'),	
			__('GALLERY HEADER LEFT LINE')=> array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_gallery_header_left_line', 'default'=>'#ffbc2d'),	
			__('SECOND BOTTOM SLIDE OVERLAY')=> array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_main_bottom_slide_overlay', 'default'=>'#000000'),
			__('AUDIO PROGRESS BAR')=> array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_gallery_audio_progress_bar', 'default'=>'#ffbf38'),	
		),
		
		'gdl_panel_slider' => array(
			__('BG SLIDER TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_bg_slider_text_color','default'=>'#ffffff'),
			__('SLIDER TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_title_color','default'=>'#ffbc2d'),
		...
		'gdl_panel_blog_port' => array(
			__('PORT THUMBNAIL TITLE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_color','default'=>'#ffbc2d',
				'description'=>'This is the portfolio thumbnail title color.'),
			__('PORT THUMBNAIL TITLE HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_hover_color','default'=>'#ffd885',
				'description'=>'This is the portfolio thumbnail title color in "hover" state.'),
			__('PORT THUMBNAIL CONTENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_thumbnail_content','default'=>'#d6d6d6'),
			__('PORT THUMBNAIL CONTENT BG', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_thumbnail_content_bg','default'=>'#000000'),
			__('PORT NO IMAGE BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_no_image_background','default'=>'#ffbc2d'),
			__('BLOG TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_title_color','default'=>'#ffbc2d',
				'description'=>'This is the blog thumbnail title color except the blog in WIDGET style.'),
			__('BLOG TITLE HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_title_hover_color','default'=>'#ffd885',
				'description'=>'This is the blog thumbnail title color in "hover" state.'),
			__('BLOG INFO COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_info_color','default'=>'#a8a8a8',
				'description'=>"This is the blog informateion color. It's include the color of blog date, blog comments number and blog author."),
			__('BLOG ABOUT AUTHOR BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_about_author_color','default'=>'#121212',
				'description'=>'The author item is located in the blog page, you can enable/disable it using the post/portfolio options.'),
			__('PAGINATION TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_pagination_text','default'=>'#ffffff',
				'description'=>'A paginaltion background color in non-hover and not-current page state.'),		
			__('PAGINATION HOVER TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_pagination_hover_text','default'=>'#000000',
				'description'=>'A paginaltion background color in non-hover and not-current page state.'),		
			__('PAGINATION HOVER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_pagination_hover_background','default'=>'#ffbc2d',
				'description'=>'A paginaltion background color in non-hover and not-current page state.'),
		),			
		
		'gdl_panel_contact_form' => array(
			__('CONTACT FORM/COMMENT BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_contact_form_background_color','default'=>'#383838',
			...
			__('CONTACT FORM/COMMENT BORDER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_contact_form_border_color','default'=>'#1f1f1f'),
		),				
		
		'gdl_panel_additional_elements' => array(
			__('DIVIDER LINE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_divider_line','default'=>'#383838',
				'description'=>'This is the color of all divider inside the container( excluding divider of the footer ).'),
			__('DIVIDER ITEM BACK TO TOP TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_back_to_top_text_color','default'=>'#ececec',
				'description'=>'This is the back to top text color of the divider item ( create from page items or shortcode ).'),		
			__('TAB BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_tab_background_color','default'=>'#292929',
				'description'=>'This is the tab header background in "non-active" state.'),
			__('TAB TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_tab_text_color','default'=>'#808080'),
			__('TAB ACTIVE BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_tab_active_background_color','default'=>'#404040',
				'description'=>'This is the tab header background in "active" state.'),		
			__('TAB ACTIVE TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_tab_active_text_color','default'=>'#e0e0e0'),
			__('TAB BORDER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_tab_border_color','default'=>'#242424'),
			__('TESTIMONIAL TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_testimonial_text','default'=>'#f7f7f7'),
			__('TESTIMONIAL TEXT AUTHOR COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_testimonial_author','default'=>'#f7f7f7'),
			__('TESTIMONIAL TEXT POSITION COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_testimonial_position','default'=>'#c2c2c2'),			
			__('BUTTON BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_button_background_color','default'=>'#f1f1f1',
				'description'=>'This color will changes all of the button background color in this theme except the button from shortcode.'),			
			__('BUTTON BORDER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_button_border_color','default'=>'#dedede',
				'description'=>'This color will changes all of the button border color in this theme except the button from shortcode.'),			
			__('BUTTON TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_button_text_color','default'=>'#7a7a7a',
				'description'=>'This color will changes all of the button text color in this theme except the button from shortcode.'),			
			__('BUTTON TEXT HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_button_text_hover_color','default'=>'#7a7a7a',
				'description'=>'This color will changes all of the button text color of "hover" state in this theme except the button from shortcode.'),			
		),
	...
	*/
	...
	function print_panel_font_combobox($title, $values){
		...
		$elements = get_font_array( $exclude );
