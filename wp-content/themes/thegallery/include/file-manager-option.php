<?php
	...
	*/
	...
	function register_gdl_file_manager_scripts(){
		...
		wp_register_script('jquery-ui', GOODLAYERS_PATH.'/include/plugin/elfinder/js/jquery-ui-1.10.4.custom.min.js', false, '1.0', true);
		wp_enqueue_script('jquery-ui');	
		
		wp_deregister_script('elfinder');
		wp_register_script('elfinder', GOODLAYERS_PATH.'/include/plugin/elfinder/js/elfinder.min.js', false, '1.0', true);
	...
	function register_gdl_file_manager_styles(){
		...
		wp_enqueue_style('elfinder',GOODLAYERS_PATH.'/include/plugin/elfinder/css/elfinder.min.css');
		wp_enqueue_style('jquery_ui',GOODLAYERS_PATH.'/include/plugin/elfinder/css/smoothness/jquery-ui-1.10.4.custom.min.css');
